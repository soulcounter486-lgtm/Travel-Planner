            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  ...
                  <div className="space-y-4 max-h-[1200px] overflow-y-auto p-1 pr-2 custom-scrollbar border-t pt-4">
            ...
            <Controller
              ...
              render={({ field }) => (
                <SectionCard title="골프 라운딩 견적 (선택)" icon={Flag} isEnabled={field.value ?? false} onToggle={field.onChange} gradient="from-emerald-600/10">
                  <div className="space-y-4 max-h-[1200px] overflow-y-auto p-1 pr-2 custom-scrollbar">
