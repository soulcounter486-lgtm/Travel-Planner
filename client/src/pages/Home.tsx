      ...
      <footer className="bg-slate-900 text-white mt-24 pb-12 pt-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Contact Card 1 */}
            <div className="bg-slate-800/50 p-5 rounded-xl border border-slate-700/50 hover:bg-slate-800 transition-all group">
              ...
              <h3 className="font-bold text-base mb-1 text-slate-100">베트남 현지</h3>
              <a href="tel:0899326273" className="text-xl font-mono text-slate-300 hover:text-blue-400 transition-colors">
                089.932.6273
              </a>
            </div>
            ...
            <div className="bg-slate-800/50 p-5 rounded-xl border border-slate-700/50 hover:bg-slate-800 transition-all group">
              ...
              <h3 className="font-bold text-base mb-1 text-slate-100">한국 직통</h3>
              <a href="tel:01090774860" className="text-xl font-mono text-slate-300 hover:text-indigo-400 transition-colors">
                010.9077.4860
              </a>
            </div>
            ...
            {/* Contact Card 3 */}
            <div className="bg-slate-800/50 p-5 rounded-xl border border-slate-700/50 hover:bg-slate-800 transition-all group">
              <div className="w-10 h-10 bg-yellow-500/10 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <MessageSquare className="w-5 h-5 text-yellow-500" />
              </div>
              <h3 className="font-bold text-base mb-1 text-slate-100">카카오톡</h3>
              <div className="flex flex-col gap-2">
                <div className="text-lg font-bold text-slate-300">ID: vungtau</div>
                <a 
                  href="http://pf.kakao.com/_TuxoxfG" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center text-xs font-semibold bg-yellow-500 text-slate-900 px-3 py-1.5 rounded-full hover:bg-yellow-400 transition-colors gap-1.5 w-fit"
                >
            ...
            <div className="bg-slate-800/50 p-5 rounded-xl border border-slate-700/50 hover:bg-slate-800 transition-all group">
              ...
              <h3 className="font-bold text-base mb-1 text-slate-100">공식 블로그</h3>
              <a 
                href="https://m.blog.naver.com/vungtausaver" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center text-emerald-400 hover:text-emerald-300 transition-colors gap-1.5 text-base font-semibold"
              >
                vungtausaver
          ...
          <div className="mt-12 pt-6 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-500 text-xs">
