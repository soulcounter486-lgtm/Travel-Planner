            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  ...
                  <div className="space-y-4 overflow-y-auto p-4 custom-scrollbar border-2 border-slate-200 bg-slate-100 rounded-xl relative my-4 shadow-inner" style={{ maxHeight: "400px", minHeight: "200px", zIndex: 1 }}>
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              ...
                              >
                                ...
                                <SelectContent className="z-[99999] bg-white border shadow-lg opacity-100">
