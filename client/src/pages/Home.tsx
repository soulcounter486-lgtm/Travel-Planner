          ...
          {isAuthLoading ? null : isAuthenticated ? (
            <div className="flex items-center gap-1 mb-2 justify-end">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      size="sm"
                      variant="default"
                      className="shrink-0 rounded-full h-6 px-1.5 text-[9px] bg-orange-500 hover:bg-orange-600"
              ...
              <Link href="/mypage">
                <Button
                  size="sm"
                  variant="outline"
                  className="shrink-0 rounded-full h-6 px-1.5 text-[9px]"
            ...
            <div className="flex items-center gap-1 mb-2 justify-end">
              <a href="/api/auth/kakao" data-testid="button-login-kakao">
                <Button
                  size="sm"
                  className="shrink-0 rounded-full h-6 px-2 text-[9px] bg-[#FEE500] hover:bg-[#FDD800] text-[#3C1E1E] border-0"
                >
              ...
              <a href="/api/login" data-testid="button-login">
                <Button
                  size="sm"
                  variant="default"
                  className="shrink-0 rounded-full h-6 px-2 text-[9px]"
                >
