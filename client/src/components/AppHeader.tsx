                  ...
                  {authScreen === 'emailVerification' ? (
                    ...
                    <>
                      ...
                      <div className="space-y-3 max-h-[60vh] overflow-y-auto">
                        <div className="flex items-center justify-between sticky top-0 bg-popover z-10 pb-1">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <div>
                              <Label htmlFor="reg-password" className="text-xs">비밀번호 * (6자↑)</Label>
                              <Input
                                id="reg-password"
                                type="password"
                                placeholder="••••••"
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <div>
                              <Label htmlFor="reg-nickname" className="text-xs">닉네임</Label>
                              <Input
                                id="reg-nickname"
                                type="text"
                                placeholder="별명"
                            ...
                            <div>
                              ...
                              >
                                <SelectTrigger className="h-7 text-sm" data-testid="select-register-gender">
